...
function useDomObserver(targetRef, config = {}) {
    ...
    const resizeObserverRef = require$$0.useRef(null);
    const mutationObserverRef = require$$0.useRef(null);
    // Create debounced callbacks
    const debouncedResize = require$$0.useCallback(createDebouncedCallback((entry) => {
        onResize?.(entry);
    }, debounceMs), [onResize, debounceMs]);
    const debouncedMutate = require$$0.useCallback(createDebouncedCallback((mutations) => {
        onMutate?.(mutations);
...
const SkeletonPrimitive = ({ block, animation = 'shimmer', speed = 1, theme = 'auto', }) => {
    ...
    const animationStyles = require$$0.useMemo(() => {
...
const SkeletonOverlay = require$$0.forwardRef(({ loading, children, animation = 'pulse', speed = 1, preserveStaticText = false, hideTextDuringLoading = true, theme = 'auto', enabled = true, className = '', onScanComplete, }, ref) => {
    ...
    const [skeletonBlocks, setSkeletonBlocks] = require$$0.useState([]);
    const [isSSRHydrated, setIsSSRHydrated] = require$$0.useState(false);
     ...
     */
    const scanAndGenerateSkeletons = require$$0.useCallback(() => {
...
exports.SkeletonOverlay = SkeletonOverlay;
exports.SkeletonPrimitive = SkeletonPrimitive;
exports.SkeletonRenderer = SkeletonRenderer;
exports.VERSION = VERSION;
exports.calculateBlocksCoverage = calculateBlocksCoverage;
exports.createSkeletonBlocks = createSkeletonBlocks;
exports.extractBorderRadius = extractBorderRadius;
exports.generateShimmerGradient = generateShimmerGradient;
exports.generateSkeletonColor = generateSkeletonColor;
exports.generateWaveGradient = generateWaveGradient;
exports.isLightColor = isLightColor;
exports.mergeOverlappingBlocks = mergeOverlappingBlocks;
exports.optimizeSkeletonBlocks = optimizeSkeletonBlocks;
exports.removeRedundantBlocks = removeRedundantBlocks;
exports.scanComponentTree = scanComponentTree;
exports.scanDOMElement = scanDOMElement;
exports.useDomObserver = useDomObserver;
